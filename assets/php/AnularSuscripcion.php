...
try{
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        //Generar token en la base de datos
    ...
    ';
        ...
        // Recibe los parametros de la url que se mando por correo
        ...
        //Anular suscripcion en la base de datos
     ...
     echo json_encode([
        'status' => 'error',
         'ex' => 'error en anular suscripcion php'
    ]);
    exit();
}
?>