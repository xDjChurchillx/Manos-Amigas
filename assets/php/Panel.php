...
try{
    ...
    $navbar = '
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu bg1color text-white dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#cambiarContrasenaModal">Cambiar contraseña</a></li>
